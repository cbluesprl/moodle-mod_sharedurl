 ...
 */
class moodle1_mod_sharedurl_handler extends moodle1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        // write sharedurl.xml
        $this->open_xml_writer("activities/sharedurl_{$moduleid}/sharedurl.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'sharedurl', 'contextid' => $contextid));
        $this->write_xml('url', $url, array('/sharedurl/id'));
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();

        // write inforef.xml
        $this->open_xml_writer("activities/sharedurl_{$moduleid}/inforef.xml");
